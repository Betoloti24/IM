<?php $_titulo = "Modificar Producto"; ?>
...
<?php if (isset($_SESSION['usuario'])) { ?>
    ...
    <?php 
        ...
        if (!$resultado){
            $_SESSION['mensaje'] = 'Se produjo un problema consultar el producto, realice la modificacion mas tarde';
                ...
                <div class="col-10">
                    <div class="card">
                        <div class="card-body bg-light shadow-lg">
                            ...
                            <form method="POST" action="../php/modificar.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                                <div class="row py-3 px-5 mt-3">
                                    <div class="col-6">
                                        <div class="row">
                                            <div class="col-12 pt-1">
                                                <h2><label for="nombre" class="form-label">Ingrese el Nombre del Producto: </label></h2>
                                                <input type="text" class="form-control form-control-lg mb-2" id="nombre" name="nombre" required autocomplete="off" value="<?php echo $producto["nombre"]; ?>">
                                            </div>
                                            <div class="col-12 pt-1">
                                                <h2><label for="marca" class="form-label">Ingrese la Marca del Producto:</label></h2>
                                                <input type="text" class="form-control form-control-lg mb-2" id="marca" name="marca" required autocomplete="off" value="<?php echo $producto["marca"]; ?>">
                                            </div>
                                            <div class="col-12 pt-1">
                                                <div class="row mx-0 px-0">
                                                    ...
                                                    <div class="col-2 mx-0 px-0">
                                                        <input type="number" class="form-control form-control-lg mb-2" id="cantidad" value="<?php echo $producto["cantidad"]; ?>" name="cantidad" required autocomplete="off" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 pt-1">
                                                <div class="row mx-0 px-0">
                                                    ...
                                                    <div class="col-2 mx-0 px-0">
                                                        <input type="number" class="form-control form-control-lg mb-2" value="<?php echo $producto['precio']; ?>" step="any" id="precio" name="precio" required autocomplete="off" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-4 mx-0 px-0">
                                                        <div class="row">
                                                            <div class="col-5 mx-0 px-0 ms-1">
                                                                <input type="number" class="form-control form-control-lg mb-2 ps-2" step="any"  id="peso" value="<?php echo $producto["pesokg"]; ?>" name="peso" required autocomplete="off" min="0">
                                                            </div>
                                                            <div class="col-6 mx-0 px-0">
                                                                <div class="form-group">
                                                                    <select name="unidad" class="form-select form-select-lg ps-2">
                                                                        <option value="KG" <?php if ($producto["unidad"] = 'KG'){ echo "active"; } ?> >KG</option>
                                                                        <option value="L"  <?php if ($producto["unidad"] = 'L'){ echo "active"; } ?>>L</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12 d-flex justify-content-between mb-3">
                                                <a href="modificarproducto.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-primary px-4"><h3>Limpiar</h3></button></a>
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#modalmodificar" class="btn btn-primary px-4"><h3>Actualizar</h3></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                ...
                                <!-- MODAL -->
                                <div class="modal fade" id="modalmodificar" tabindex="-1" aria-hidden="true" aria-labelledby="label-modal2" data-bs-backdrop="static">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="h4">Se va a modificar toda la informacion del producto <b><?php echo $producto['nombre'] ?> <?php echo $producto['marca'] ?></b>. ¿Esta seguro que desea continuar? </p>
                                            </div>
                                            <!-- Cuerpo del footer -->
